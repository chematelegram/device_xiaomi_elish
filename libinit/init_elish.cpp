...
void witch_elish()
{
  ...
  dv variants[2] = {
      {"2105K81AC", "elish", "Xiaomi/elish/elish:13/RKQ1.211001.001/V816.0.1.0.TKYCNXM:user/release-keys",
       "missi_padext4_cn-user 13 TKQ1.221114.001 V816.0.1.0.TKYCNXM release-keys"},
  };
